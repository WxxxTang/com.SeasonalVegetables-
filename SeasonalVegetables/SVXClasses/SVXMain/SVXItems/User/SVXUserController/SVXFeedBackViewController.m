...
@interface SVXFeedBackViewController ()<UITextViewDelegate, UITextFieldDelegate, MFMailComposeViewControllerDelegate>
...
@implementation SVXFeedBackViewController
...
- (void)p_createOtherThing {
    ...
    self.sendButton.backgroundColor = [UIColor colorWithRed:214 / 255.0 green:214 / 255.0 blue:214 / 255.0 alpha:1];
